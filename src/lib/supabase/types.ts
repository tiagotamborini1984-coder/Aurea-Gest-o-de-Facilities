    ...
    Tables: {
      ...
      budget_accounts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'budget_accounts_cost_center_id_fkey'
...
//   FOREIGN KEY budget_accounts_cost_center_id_fkey: FOREIGN KEY (cost_center_id) REFERENCES budget_cost_centers(id) ON DELETE CASCADE
...
//   UNIQUE budget_entries_account_id_reference_month_key: UNIQUE (account_id, reference_month)
...
// Table: budget_entries
//   CREATE UNIQUE INDEX budget_entries_account_id_reference_month_key ON public.budget_entries USING btree (account_id, reference_month)
// Table: clients

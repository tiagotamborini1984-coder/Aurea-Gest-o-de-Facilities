...
//   scoring_settings: jsonb (nullable, default: '[{"score": 1, "description": "Muito Ruim"}, {"score": 2, "description": "Ruim"}, {"score": 3, "description": "Regular"}, {"score": 4, "description": "Bom"}, {"score": 5, "description": "Excelente"}]'::jsonb)
...
//   $function$
//
// FUNCTION submit_audit_execution(uuid, jsonb, text, boolean)
//   CREATE OR REPLACE FUNCTION public.submit_audit_execution(p_execution_id uuid, p_answers jsonb, p_participants text, p_is_draft boolean DEFAULT false)
//    RETURNS jsonb
//    LANGUAGE plpgsql
//    SECURITY DEFINER
//   AS $function$

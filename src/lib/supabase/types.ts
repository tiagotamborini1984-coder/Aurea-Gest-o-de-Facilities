...
// Table: audit_actions
//   Policy "authenticated_all_audit_actions" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
// Table: audit_assignments
//   Policy "authenticated_all_audit_assignments" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
// Table: audit_execution_answers
//   Policy "authenticated_all_audit_execution_answers" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
// Table: audit_executions
//   Policy "authenticated_all_audit_executions" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
// Table: audit_logs
...
//     USING: true
// Table: audits
//   Policy "authenticated_all_audits" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
// Table: cleaning_gardening_areas
...
//     USING: true
// Table: plant_non_working_days
//   Policy "Allow authenticated full access on plant_non_working_days" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
// Table: plants

...
//     USING: ((get_user_role() = ANY (ARRAY['Master'::text, 'Administrador'::text])) OR (id = get_user_client_id()))
//     WITH CHECK: ((get_user_role() = ANY (ARRAY['Master'::text, 'Administrador'::text])) OR (id = get_user_client_id()))
// Table: companies

...
//       IF v_new_status_name ILIKE '%requisição%' OR v_new_status_name ILIKE '%requisicao%' OR v_new_status_name ILIKE '%rc %' OR v_new_status_name ILIKE '%cotação%' OR v_new_status_name ILIKE '%cotacao%' THEN

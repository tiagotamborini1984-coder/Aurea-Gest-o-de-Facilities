                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="pl-9 h-11 bg-black/20 border-white/10 focus-visible:ring-[#1e3a8a] text-white placeholder:text-gray-500 transition-all"
                        value={email}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        type="password"
                        placeholder="••••••••"
                        className="pl-9 h-11 bg-black/20 border-white/10 focus-visible:ring-[#1e3a8a] text-white transition-all"
                        value={newPassword}

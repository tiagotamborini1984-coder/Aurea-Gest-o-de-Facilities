...
export const ppeService = {
  ...
  async getLoans(clientId: string, startDate?: string, endDate?: string, plantId?: string) {
    let query = (supabase as any)
      .from('ppe_loans')
  ...
  async getLoanTrends(clientId: string, startDate?: string, endDate?: string, plantId?: string) {
    let query = (supabase as any)
      .from('ppe_loans')

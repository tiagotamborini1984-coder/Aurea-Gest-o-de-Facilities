-- ============================================================================
-- Migration: Final strict active-only filtering for attendance + Sorriso cleanup
-- Ensures get_attendance_employees ONLY returns employees with status = 'Ativo'
-- and deactivates specific excluded collaborators at the Sorriso plant.
-- Fully idempotent: safe to run multiple times.
-- ============================================================================

-- ============================================================================
-- 0. Fix trigger_audit_daily_logs to handle NULL auth.uid() during migrations
--    When auth.uid() is NULL (migration context), skip audit insert to avoid
--    FK violation on audit_logs.user_id -> auth.users(id).
-- ============================================================================
...
--    This ensures clean slate before recreating with strict filtering.
-- ============================================================================
...
-- ============================================================================
-- 5. Deactivate specific collaborators at the Sorriso plant (idempotent)
...
--    This allows the fallback query in the frontend to work correctly.
-- ============================================================================
DO $$
BEGIN
  IF NOT EXISTS (

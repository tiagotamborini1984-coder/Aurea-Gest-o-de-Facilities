-- Comprehensive normalization of inventory_products.category using unaccent extension
-- Ensures product categories exactly match inventory_categories names (case-insensitive, accent-insensitive, trimmed)
-- Idempotent: safe to run multiple times

-- Enable unaccent extension for reliable accent removal across all Unicode characters
...
--    using unaccent for comprehensive accent removal + case-insensitive comparison

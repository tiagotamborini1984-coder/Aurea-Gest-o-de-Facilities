-- ============================================================================
-- Migration: Strict active-only filtering in attendance RPC + Sorriso cleanup
...
--    Strictly returns only active employees, ignoring p_staff_log_ids for inactive inclusion
-- ============================================================================
CREATE OR REPLACE FUNCTION public.get_attendance_employees(
  p_plant_id uuid,

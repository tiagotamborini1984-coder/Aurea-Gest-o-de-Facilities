-- The audits.frequency column is TEXT, so "Quinzenal" is already supported at the schema level.
-- This migration updates the recurrence trigger function to handle the "Quinzenal" (bi-weekly, 15-day) frequency.
